...
def main():
    ...
    for server in servers:
        ...
        console.print(
            f"  {status} | {server.name:25} | {server.transport.value:15} | {server.server_type.value}"
        )
    ...
    console.print("• Multi-server support: ✓ Working")
    console.print("• Transport types: stdio, streamable_http")
